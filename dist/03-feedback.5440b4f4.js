...
formEl.addEventListener("input", (0, _lodashThrottleDefault.default)(onInput, 500));
formEl.addEventListener("submit", (0, _lodashThrottleDefault.default)(onSubmit, 500));
checkingLS();
